	...
	<div class="container">
        ...
        <div class="main">
           ...
           <div class="card text-center">
                ...
                <div class="card-body">
                <h2 class="card-title">Autorizaciones Médicas</h2>
                    <table class="table">
                        <thead>
                            <tr>
                               <th>No. Radicado</th>
                        ...
                        <tbody>
                            |<?php 
                                ...
                                $SQL="SELECT autorizaciones.id, autorizaciones.tipo_doc, autorizaciones.no_doc, autorizaciones.fecha_s, autorizaciones.no_auto,autorizaciones.estado FROM autorizaciones";
